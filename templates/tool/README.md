...
This folder is now documentation-only. The canonical tool template lives here:

- <https://github.com/AeroBeat-Workouts/aerobeat-template-tool>
...
- Tool/workflow package starting point.
...
## Tool-specific rename reminder

For tool repos, the very first cleanup step after clone is to replace placeholder manager names with the repo's real public contract, including file names, `class_name` declarations, tests, docs, and any autoload registration.
