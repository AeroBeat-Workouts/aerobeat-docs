# Asset (Internal) Template

This folder is now documentation-only. The canonical asset (internal) template lives here:

- <https://github.com/AeroBeat-Workouts/aerobeat-template-asset>
...
- Internal asset package starting point.
