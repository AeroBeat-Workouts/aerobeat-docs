...
This folder is now documentation-only. The canonical skin template lives here:

- <https://github.com/AeroBeat-Workouts/aerobeat-template-skin>
...
- Community skin package starting point.
