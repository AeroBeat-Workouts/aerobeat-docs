...
This folder is now documentation-only. The canonical environment template lives here:

- <https://github.com/AeroBeat-Workouts/aerobeat-template-environment>
...
- Community environment package starting point.
