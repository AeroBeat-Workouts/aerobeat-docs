...
| **Content Core** | `aerobeat-content-core` | Durable authored-content contracts: `Song`, `Routine`, `Chart`, `Workout`, shared chart envelope. | **None** | **None** | Unit test tools | **MPL 2.0** |
...
* `aerobeat-content-core` owns `Song`, `Routine`, `Chart`, `Workout`, and the shared chart envelope.
