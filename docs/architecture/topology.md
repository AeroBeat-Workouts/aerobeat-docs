...
| **Content Core** | `aerobeat-content-core` | Durable authored-content contracts: `Song`, `Chart`, `Set`, `Workout`, shared chart envelope. | **None** | **None** | Unit test tools | **MPL 2.0** |
...
* `aerobeat-content-core` owns `Song`, `Chart`, `Set`, `Workout`, and the shared chart envelope.
