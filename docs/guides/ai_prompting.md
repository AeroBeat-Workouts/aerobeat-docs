...
We have established three static files in `docs/ai_context/` that define our universe. You must **always** provide these to the AI before asking it to write code.
...
1.  Zip the `docs/ai_context/` folder.
