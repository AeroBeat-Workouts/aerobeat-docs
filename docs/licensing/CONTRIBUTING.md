...
3.  **Sign the CLA:** To ensure we can protect the project and support commercial ports (which fund the project), we require a [Contributor License Agreement](CLA.md) for code contributions.
